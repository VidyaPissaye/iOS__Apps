...
#import "PVInboxViewController.h"
#import "PVImageViewController.h"
#import "MSCellAccessory.h"

@interface PVInboxViewController ()

@end

@implementation PVInboxViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"showLogin"]) {
        ...
        [segue.destinationViewController setHidesBottomBarWhenPushed:YES];
        PVImageViewController *imageViewController = (PVImageViewController *) segue.destinationViewController;
