...
#import "PVFriendsViewController.h"
#import "PVEditFriendsViewController.h"
#import "GravatarUrlBuilder.h"

@interface PVFriendsViewController ()

@end

@implementation PVFriendsViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if([segue.identifier isEqualToString:@"showEditFriends"]) {
        PVEditFriendsViewController *viewController = (PVEditFriendsViewController *) segue.destinationViewController;
